...
MODEL_FILENAME_face = 'model_face.tflite'
LABELS_FILENAME_face = 'labels_face.txt'
MODEL_FILENAME_cars = 'model_cars.tflite'
LABELS_FILENAME_cars = 'labels_cars.txt'
...
def main(args, opt, model, smallfont, medfont, bigfont):
    global last_spoken
...
def run_process():
    ...
    while True:  # making a loop
        ...
        if new_switch_q==True and old_switch_q==False:  # if key 'q' is pressed 
            ...
            main(args, 1, face_model, smallfont, medfont, bigfont)
            time.sleep(0.1)
        if new_switch_a==True and old_switch_a==False:  # if key 'q' is pressed 
            ...
            main(args, 2, model, smallfont, medfont, bigfont)
            time.sleep(0.1)
